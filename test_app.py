...
class TestApp(unittest.TestCase):
    ...
    def test_model_exists(self):
        ...
        self.assertTrue(
            os.path.exists(model_path), f"Model file not found at {model_path}"
        )
    ...
    def test_model_loading(self):
        ...
        try:
            ...
            self.assertIsNotNone(
                model, "Model should not be None after loading"
            )
    ...
    def test_model_prediction(self):
        ...
        try:
            ...
            self.assertEqual(
                len(prediction), 1, "Should return one prediction"
            )
        except Exception as e:
